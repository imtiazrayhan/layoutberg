	...
	const examples = [
		{
			...
			prompt: __(
				'Create a hero section with a large background image, centered headline, subtitle, and two call-to-action buttons',
				'layoutberg'
			),
			tip: __(
				'Be specific about layout elements and their arrangement',
				'layoutberg'
			),
		},
		{
			...
			prompt: __(
				'Design a 3-column feature grid with icons, headings, and descriptions. Use a light background with subtle shadows on each feature card',
				'layoutberg'
			),
			tip: __(
				'Mention specific styling preferences like shadows, backgrounds, or spacing',
				'layoutberg'
			),
		},
		{
			...
			prompt: __(
				'Build a testimonial section with customer quotes, names, and companies. Include star ratings and make it responsive',
				'layoutberg'
			),
			tip: __(
				'Include details about the content type and responsive behavior',
				'layoutberg'
			),
		},
	];
	...
	const bestPractices = [
		{
			...
			description: __(
				'Include details about colors, spacing, alignment, and overall style',
				'layoutberg'
			),
		},
		{
			...
			description: __(
				'Mention columns, rows, sections, and how elements should be arranged',
				'layoutberg'
			),
		},
		{
			...
			description: __(
				'Specify if you want headings, paragraphs, images, buttons, etc.',
				'layoutberg'
			),
		},
		{
			...
			description: __(
				'Use natural language instead of CSS properties or technical terms',
				'layoutberg'
			),
		},
		{
			...
			description: __(
				'Avoid prompts like "make it nice" or "create something cool"',
				'layoutberg'
			),
		},
	];
			...
			content: (
				<div className="layoutberg-onboarding__best-practices">
					{ bestPractices.map( ( practice, index ) => (
						...
						>
							<span
								className={ `dashicons dashicons-${ practice.icon }` }
							></span>
							<div>
			...
			content: (
				<div className="layoutberg-onboarding__quick-start">
					...
					<div className="layoutberg-onboarding__formula">
						...
						<span className="layoutberg-onboarding__formula-plus">
							+
						</span>
						<div className="layoutberg-onboarding__formula-part">
							<span>2</span>
					...
					<div className="layoutberg-onboarding__formula-result">
						<p>
							...
							{ __(
								'"Create a pricing table with 3 columns in a modern design with shadows"',
								'layoutberg'
							) }
						</p>
					</div>
	...
	return (
		<div className="layoutberg-onboarding__step layoutberg-onboarding__step--prompt-tips">
			...
			<p className="layoutberg-onboarding__step-description">
				{ __(
					"Great prompts lead to amazing layouts. Here's how to get the best results.",
					'layoutberg'
				) }
			</p>

			<TabPanel className="layoutberg-onboarding__tabs" tabs={ tabs }>
				{ ( tab ) => tab.content }
			</TabPanel>
		</div>
	);
