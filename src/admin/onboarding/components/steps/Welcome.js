		...
		<div className="layoutberg-onboarding__step layoutberg-onboarding__step--welcome">
			<div className="layoutberg-onboarding__welcome-hero">
				...
				<p className="layoutberg-onboarding__welcome-subtitle">
					{ __(
						'Transform your ideas into stunning layouts with AI-powered design',
						'layoutberg'
					) }
				</p>
			</div>
			...
			<div className="layoutberg-onboarding__welcome-features">
				<div className="layoutberg-onboarding__feature">
					...
					<p>
						{ __(
							'Generate complete, responsive layouts using natural language prompts',
							'layoutberg'
						) }
					</p>
				</div>
				<div className="layoutberg-onboarding__feature">
					...
					<p>
						{ __(
							'Creates native WordPress blocks without proprietary page builders',
							'layoutberg'
						) }
					</p>
				</div>
				<div className="layoutberg-onboarding__feature">
					...
					<p>
						{ __(
							'Optimized for speed with smart caching and efficient API usage',
							'layoutberg'
						) }
					</p>
				</div>
				<div className="layoutberg-onboarding__feature">
					...
					<p>
						{ __(
							'Choose from OpenAI GPT and Claude models to match your needs',
							'layoutberg'
						) }
					</p>
				</div>
